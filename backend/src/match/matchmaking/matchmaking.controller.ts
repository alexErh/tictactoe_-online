...
export class MatchmakingController {
  ...
  @ApiResponse({
    status: 201,
    description: 'Spieler erfolgreich der Warteschlange hinzugefügt.',
  })
  @ApiResponse({
    status: 200,
    description: 'Ein passender Gegner wurde gefunden.',
    type: Object,
  })
  async joinQueue(@Body() playerData: JoinQueueDto) {
    ...
    return match
      ...
      : {
          message:
            'Kein passender Gegner gefunden, Spieler in die Warteschlange aufgenommen.',
        };
  }
}
